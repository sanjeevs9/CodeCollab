...
import { classSchema, projectSchema } from "../middleware/zodmiddleware.js";
...
//create class
router.post("/class/create", authmiddleware, async (req: Request, res: Response) => {
...
//get all classes
router.get("/class/get/all", authmiddleware, async (req: Request, res: Response) => {
  try {
...
router.get("/class/get/teacher", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
...
router.get("/class/get/student", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  console.log({ userId });
...
//delete class
router.post("/class/delete/:id", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
...
router.post("/class/request/create", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  const { classId, teacherId } = req.body as {
    classId?: string;
    teacherId?: string;
  };
...
router.get("/class/request/get", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  try {
    const user = await prisma.user.findFirst({
      where: {
...
router.post("/class/request/handle", authmiddleware, async (req: Request, res: Response) => {
  ...
  try {
    ...
    return res.status(500).json({
      message: (err as Error).message || "Failed to handle request",
    });
  }
});

//create project
router.post("/project/create", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  const value = req.body;
  try {
...
//get all projects
router.get("/class/:classId", authmiddleware, async (req: Request, res: Response) => {
...
//delete project
router.post("/project/delete/:id", authmiddleware, async (req: Request, res: Response) => {
  const id = req.params.id;
  const userId = req.USERID;
...
router.post("/project/code/save/:id", authmiddleware, async (req: Request, res: Response) => {
...
router.get("/project/code/:id", authmiddleware, async (req: Request, res: Response) => {
  const projectId = req.params.id;
  try {
...
//update class name
router.post("/class/update/:id", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  const id = req.params.id;
  const value = req.body;
...
//update project name
router.post("/project/update/:id", authmiddleware, async (req: Request, res: Response) => {
  const userId = req.USERID;
  const id = req.params.id;
  const value = req.body;
  ...
  try {
    ...
    return res.status(500).json({
      message: (err as Error).message || "Failed to update project",
    });
  }
});
